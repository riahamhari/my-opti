/**
Developed by: Riah
Test name: Test 178 - Course packages Nav v1
**/
const tagInterval = setInterval(() => {
    if (typeof (window === null || window === void 0 ? void 0 : window.clarity) === 'function') {
        window.clarity('set', 'test-178', 'variation1');
        clearInterval(tagInterval);
    }
}, 300);
(() => {
    'use strict';
    let articlesLink, courseDropdown;
    ...
    const optiInit = () => {
        if (document.querySelector('.opti_course_packages_nav'))
            return;
