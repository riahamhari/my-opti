...
// 											<p id="opti_split_payments">8 easy payments of only ${priceStr}<br />Instant access. No fees. <a class="opti_popover_trigger">Learn More.</a>${popoverHtml}</p>
// 										</div>
// 										`;
...
(() => {
    ...
    const optiInit = (paymentInfoSpan, ppFieldset) => {
        ...
        ppFieldset.insertAdjacentHTML('beforeend', `<div class="opti-payment-methods__not-logged-in-overlay" ${greenCheckIcon.classList.contains('hidden') ? 'style="display: block;"' : ''}></div>`);
