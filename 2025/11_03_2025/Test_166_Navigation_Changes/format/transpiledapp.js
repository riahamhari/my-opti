...
(() => {
    ...
    const myInterval = setInterval(() => {
        ...
        const starterPackageDropdownVip = document.querySelector('[href="/hpa-starter-package/"] ~ .cre-nav-dropdown .cre-dropdown');
        const secondaryNavContactUs = document.querySelector('.header__top__nav__items_second [href="/contact-us/"]');
        if (btnsContainer && starterPackageDropdownVip && secondaryNavContactUs) {
            clearInterval(myInterval);
    ...
    const optiInit = (actionBtn, btnsContainer, secondaryNavContactUs) => {
        ...
        if (!actionBtn)
            return;
        secondaryNavContactUs.insertAdjacentHTML('beforebegin', `<a href="/forum/" class="">Forum</a>`);
        const starterPackageDropdownVip = document.querySelector('[href="/hpa-starter-package/"] ~ .cre-nav-dropdown .cre-dropdown .cre-el');
        const vipLink = starterPackageDropdownVip === null || starterPackageDropdownVip === void 0
            ? void 0
            : starterPackageDropdownVip.querySelector('a');
        const vipText = starterPackageDropdownVip === null || starterPackageDropdownVip === void 0
            ? void 0
