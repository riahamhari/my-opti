...
(() => {
    ...
    const createModal = ({ packageToLinkTo, saving, packageIncludes, price, totalValue, videoInfo }, courseName, enrollBtnUrl) => {
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="opti_modal_subheading">
							<h3>Add the <a class="opti_upsell_link" href=$${!1}{packageToLinkTo}>$${!1}{courseName}</a> to get $${!1}{saving} OFF</h3>
						</div>
						<div class="info-modal-content">
							<div class="info-modal-content__videoContainer">
								$${!1}{generateVideoHtml(videoInfo)}
							</div>
							<div class="info-modal-content__includes">
								...
								<ul class="info-modal-content__includes__list">
									$${!1}{packageIncludes.map((course) => `<li><span class="opti_tick_icon"></span>$${!1}{course}</li>`).join('')}
									<li><span class="opti_tick_icon"></span>and 24 months of Gold Support</li>
								</ul>
								<a href="$${!1}{packageToLinkTo}" class="info-modal-content__includes__link">See what's included here</a>
							</div>
						</div>
						<div class="info-modal-content__priceBlock">
							$${!1}{generatePriceBlockHtml(price, totalValue)}
							<div class="info-modal-content__cta">
									<a href="$${!1}{packageToLinkTo}?autoSubmit=true&OpenPaymentPlanOptions=1" class="btn btn-primary btn-large">Upgrade Now <p>60 DAY MONEY BACK GUARANTEE</p></a>
							</div>
							<a href="$${!1}{enrollBtnUrl}purchase" class="opti_no_thanks">No thanks, I just want the one course</a>
						</div>
					</div>
				</div>
			</div>
        ...
        modalClose.addEventListener('click', () => {
            ...
            window.location.href = `$${!1}{enrollBtnUrl}purchase`;
        });
    ...
    function generateVideoHtml({ href, vimeoTitle, vimeoId, imageSrc }) {
        return `
			<div class="video-mask">
				<a class="video-trigger imgLiquid_bgSize imgLiquid_ready" href="$${!1}{href}" data-vimeo-title="$${!1}{vimeoTitle}" data-vimeoid="$${!1}{vimeoId}" style="background-image: url('$${!1}{imageSrc}'); background-size: cover; background-position: 50% 0%; background-repeat: no-repeat; height: 240px;">
					<img src="$${!1}{imageSrc}" width="1140" height="600" alt="" style="display: none;">
    ...
    const generatePriceBlockHtml = (price, totalValue) => {
        ...
        const priceBlockHtml = `<div class="col-sm-12 col-md-6 tittleAndPriceBlock__price">
			...
			<span class="titleAndPriceBlock__paymentPlanLink">
				...
				<a class="line1 js_paymentPlanPurchase">8 easy payments of only $$${!1}{eightPaymentsVal}</a>
