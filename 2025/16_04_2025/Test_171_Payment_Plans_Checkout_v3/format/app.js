...
(() => {
        ...
        if (totalsFieldset &&
            ...
            const debouncePriceUpdate = debounce(() => {
                ...
                [...select.querySelectorAll('option')].forEach((option) => {
                    ...
                    const matchingPPListItem = document.querySelector(`.GenericPaymentConfirmationPage .details-form fieldset.payment-plan-section .payment-heading ul li:has(input#${value})`);
    ...
    const createPPSelect = () => {
        ...
        select.onchange = (e) => {
            ...
            const matchingRadioInput = document.querySelector(`.GenericPaymentConfirmationPage .details-form fieldset.payment-plan-section .payment-heading ul li input#${value}`);
            const matchingLabel = document.querySelector(`.GenericPaymentConfirmationPage .details-form fieldset.payment-plan-section .payment-heading ul li:has(input#${value}) label`);
            matchingLabel.click();
