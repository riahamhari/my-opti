...
(() => {
        ...
        layout.innerHTML = `<div class="row">
									<div class="opti_course_intro_wrapper">
										<div class="opti_course_intro col-sm-8">
											<h3>$${!1}{course.introduction.heading}</h3>
											<p>$${!1}{course.introduction.text}</p>
										<div class="opti_course_description">
											<h3>Course description</h3>
											<p>$${!1}{course.courseDescription}</p>
										</div>
										</div>
								...
								<div class="opti_main_content main-content--adjustMargin">					
									...
									<div class="opti_course_info_instructor">
										<img src="$${!1}{image}" alt="HP Academy Co-Founder $${!1}{name} image" />
										<div class="opti_course_info_instructor__details">
											<p class="opti_course_info_instructor__name">$${!1}{name}</p>
											<p class="opti_course_info_instructor__label">$${!1}{role}</p>	
										</div>
									</div>
            ...
            .join('')}
									...
									<div class="opti_course_audienceTypes">
										...
										<ul>
											...
											$${!1}{course.audienceTypes
            .map((audienceType) => {
            return `<li>$${!1}{audienceType}</li>`;
        })
            .join('')}
										</ul>
									</div>
    ...
    const handleModalOpen = (modalMain) => {
        const iframe = document.querySelector('#opti_video_modal_parent .modal iframe');
        const originalSrc = `https://player.vimeo.com/video/$${!1}{videoId}?byline=0&portrait=0&color=ff9933&playsinline=0&autoplay=1&transparent=0&app_id=122963&audiotrack=main`;
        ...
        faqSection.innerHTML = `<div class="opti-curriculum-content col-sm-12">
            ...
            return `<div class="hpa-section2">
																<div class="panel-heading">
																	<a data-toggle="collapse" data-parent="#hpa-accordion-common-questions" href="$${!1}{pathname}#common-question-$${!1}{index}" class="panel-title collapsed">
																		<h5>$${!1}{heading}</h5>
																		<div class="chevron">
																...
																<div id="common-question-$${!1}{index}" class="panel-collapse collapse" style="height: 0px;">
