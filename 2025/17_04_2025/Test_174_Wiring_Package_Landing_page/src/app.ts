...
(() => {
	'use strict';
	let pageHeading: HTMLElement,
		subHeading: HTMLElement,
		ctaContainer: HTMLElement,
		heroTicksContainer: HTMLElement,
		youllLearn: HTMLElement,
		wiringImage: HTMLImageElement,
		motorsportSection: HTMLElement,
		reviews: HTMLElement,
		reviewsSubtitle: HTMLElement,
		hero: HTMLElement,
		motorWiringSection: HTMLElement,
		heroEnrollBtn: HTMLAnchorElement,
		memberReviews: HTMLElement;
	const icons = {
	...
	const myInterval = setInterval(() => {
		...
		heroEnrollBtn = document.querySelector(
			'.DealsPage_Alternate2 .dealspage-alternate2 .deals-page-header-wrapper .deals-page-header .btn'
		);
		if (
			pageHeading &&
			subHeading &&
...
`;
	...
	const insertHeroTicks = (container: HTMLElement) => {
	...
	const insertYoullLearnUpdate = (wrapper: HTMLElement) => {
	...
	const createEverythingYouNeed = () => {
		...
		const youllLearnContainer = everythingYouNeed.querySelector<HTMLElement>('.row');
