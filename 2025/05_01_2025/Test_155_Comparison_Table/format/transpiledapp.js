    ...
    const createTable = (isCoursePage, courseName, key = undefined, price) => {
        ...
        const tableHtml = `<table id="opti_price_comparison_table">
            ...
            .map(({ feature, included }) => `<tr>
											<td>$${!1}{feature}</td>
											<td>$${!1}{included
            ? `<img src="$${!1}{icons.tickIcon}" alt="tick icon">`
            : `<img src="$${!1}{icons.crossIcon}" alt="cross icon">`}</td>
											<td>$${!1}{`<img src="$${!1}{icons.tickIcon}" alt="tick icon">`}</td>
										</tr>`)
            .join('')}
								
									$${!1}{!isCoursePage
            ? `	<tr>
												<td>$${!1}{numOfCourses} Courses</td>
												<td><img src="$${!1}{icons.crossIcon}" alt="cross icon"></td>
												<td><img src="$${!1}{icons.tickIcon}" alt="tick icon"></td>
											</tr>
										`
            : ''}
				...
				<div class="col-sm-12">
					<div class="btn-wrapper">
						<button
							...
							<br />
							<span>$${!1}{eightPaymentsTxt ? eightPaymentsTxt : ''}</span>
						</button>
