...
(() => {
    ...
    const optiInit = (firstRow) => {
        ...
        const freeBlockExists = matchingCourse === 'tuning starter package' || matchingCourse === 'diesel tuning starter package';
        ...
        const starterBlock = `<div id="opti_starter_block" class="col-xs-12 col-sm-6 col-md-5">
			<div class="courseSeries__preview   courseSeries__preview--thumbs " data-course-id="1845">
				<div class="courseSeries__preview__banner">
					<a href=$${!1}{packageLink}><h4>Bundle & Save!</h4></a>
				</div>
				...
				<h3 class="courseSeries__preview__title equal">$${!1}{courseName}</h3>
				<div class="video-mask">$${!1}{vimeoEmbed}</div>
				<div class="courseSeries__preview__bottom">
					<div class="row courseSeries__preview__bottom__fistRow">
						...
						<div class="col-xs-6">
							<h5 class="courseSeries__preview__lessons"><span class="number">$${!1}{numOfCourses}</span> Courses</h5>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
    ...
    const equalHeight = (rowArr) => {
        rowArr.forEach((row) => {
            ...
            headingsArr.forEach((heading) => {
                heading.style.height = `$${!1}{largestHeight}px`;
            });
        });
    };
    setTimeout(function () {
