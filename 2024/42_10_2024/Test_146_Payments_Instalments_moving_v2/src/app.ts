...
(() => {
	...
	const myInterval = setInterval(() => {
		const paymentPlanSections = document.querySelectorAll<HTMLElement>('.payment-plan-section');
	...
	const optiInit = (eightPaymentsListEl, topPaymentPlanSection) => {
		...
		const newCta: HTMLElement = paymentPlanCtaContainer.querySelector('a');
		const paymentPlanDefaultSection: HTMLElement = document.querySelector('fieldset:has(#payment-plan-section)');
