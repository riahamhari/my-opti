    ...
    const createAccordion = (currentCourses) => {
        ...
        <div class="accordion">
            <div class="accordion__title">
                <span><img class="opti_course_logo" src="$${!1}{category.courseImgSrc}" alt="$${!1}{category.courseName}"></span>
                <h4>$${!1}{category.courseName} <span>($${!1}{category.courses.length})</span></h4>
    ...
    `;
            ...
            <li class="opti_course_list_item">
                <div class="opti_course_details">
                    <h5>$${!1}{course.title} <span class="opti_course_worth">Worth $${!1}{course.oldPrice}</span></h5>
                    <p><span class="opti_course_modules">$${!1}{course.lessons.replace('Lessons', 'Modules')}</span> • <span class="opti_course_students">$${!1}{course.studentsEnrolled} Students enrolled</span></p>
                </div>
                <a href="https://www.hpacademy.com$${!1}{course.moreInfoLink}" target="_blank">
                    <span class="opti_new_window_svg">$${!1}{newWindowSvg}</span>
                </a>
            </li>
        `;
            });
        ...
        accordions.forEach((accordion) => {
            ...
            heading.addEventListener('click', function () {
                ...
                if (parent.classList.contains(accordionActiveClass)) {
                    ...
                    accordionContentWrap.style.height = `$${!1}{originalHeight}px`;
                }
            });
        });
            ...
            expandAllBtn.addEventListener('click', function () {
                ...
                accordions.forEach((accordion) => {
                    ...
                    if (allExpanded) {
                        ...
                        accordionContentWrap.style.height = `$${!1}{accordionContentWrap.scrollHeight}px`;
                    }
                    else {
                        // Collapse all
    ...
    const insertAnchorLinks = (instantAccessLi, freeAccessLi) => {
        const scrollToElement = (id) => {
            ...
            if (targetElement) {
                ...
                console.warn(`Element with ID "$${!1}{id}" not found.`);
            }
        };
