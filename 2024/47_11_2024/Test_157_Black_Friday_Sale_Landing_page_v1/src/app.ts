...
(() => {
	...
	const myInterval = setInterval(() => {
		...
		const dealsGrid: HTMLElement = document.querySelector('.course-sales-pages');
		const courseInfoBoxRow: HTMLElement = document.querySelector('.row:has(.courses-info-box-wrapper)');
		const courseRow: HTMLElement = document.querySelector('.row:has(.course-sales-pages)');
	...
	const optiInit = (header: HTMLElement, dealsGrid: HTMLElement) => {
		...
		const waitForCTA = setInterval(() => {
			const viewDealsCTA: HTMLElement = document.querySelector('#opti_black_friday_banner .opti_scroll_to_deals');
			if (viewDealsCTA) {
	...
	function initializeCountdownTimer() {
		...
		const daysElement = document.querySelector('.opti_sale_end_timer_inner_content_timer_days_number') as HTMLElement;
		const hoursElement = document.querySelector('.opti_sale_end_timer_inner_content_timer_hours_number') as HTMLElement;
		const minutesElement = document.querySelector(
			'.opti_sale_end_timer_inner_content_timer_minutes_number'
		) as HTMLElement;
		const secondsElement = document.querySelector(
			'.opti_sale_end_timer_inner_content_timer_seconds_number'
		) as HTMLElement;
