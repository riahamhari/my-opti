...
(() => {
    ...
    const myInterval = setInterval(() => {
        ...
        const paymentPlanHtml = document.querySelector('.titleAndPriceBlock__paymentPlanLink');
    ...
    const optiInit = (packageTitle, packageEl) => {
        ...
        const desktopLastPackageTitle = desktopLastPackage.querySelector('h4');
        ...
        if (lastPackageTitle.innerText === '24 Months of Gold Membership' && lastPackagePrice) {
            ...
            const lastPackageCopy = `PLUS: bonus 2 years of dedicated support and webinar access <span>worth $${!1}{lastPackagePrice}</span>`;
        ...
        const paymentPlanHtml = document.querySelector('.titleAndPriceBlock__paymentPlanLink').innerHTML;
        const eightPaymentsHtml = `<div class="opti_desktop_or">-OR-</div>
									<div class="opti_desktop_payment_plan">$${!1}{paymentPlanHtml}
...
(() => {
    ...
    const myInterval = setInterval(() => {
        ...
        const mainCta = document.querySelector('.btn-wrapper');
        const priceEl = document.querySelector('.main-content .price');
        if (vipCoursesCurrent && mainCta) {
            clearInterval(myInterval);
            optiInit(mainCta, priceEl);
        }
    }, 300);
    const optiInit = (mainCta, priceEl) => {
        const price = priceEl.innerText;
        const packageEl = document.querySelector('.package');
        const defaultBtn = document.querySelector('.btn-wrapper');
        ...
        const priceHtml = `<div class="col-sm-12 col-md-6 tittleAndPriceBlock__price opti_title_price">
			...
			<span class="titleAndPriceBlock__paymentPlanLink">
				...
				<a class="line1 js_paymentPlanPurchase" href="/vip-package/#">$${!1}{eightPaymentsText}</a>
						...
						<div class="col-sm-12">
							<div class="btn-wrapper opti-btn-wrapper">
								<button
									...
									<br />
									<span>$${!1}{eightPaymentsText}</span>
								</button>
								<div class="price">$${!1}{price}</div>
							</div>
        ...
        const optiButtonWrapper = document.querySelector('.opti-btn-wrapper');
